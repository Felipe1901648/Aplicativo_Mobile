...
class OleoActivity : AppCompatActivity() {
    ...
    fun taskDisciplinas() {
        Thread{
            disciplinas = DisciplinaService.getOleo()
            runOnUiThread {
                // atualizar lista
                ...
                NotificationUtil.create(1, intent, "LMSApp", "Já verificou o óleo hoje ?")
            }
        }.start()
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (id == R.id.action_sair) {
            ...
            val intent = Intent(context, cadastroOleo::class.java)
